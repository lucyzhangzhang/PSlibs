...
test <- read.table(file="HH/HL/up/names.cpat.dat",sep="\t",col.names=c("ID","mRNA","ORF","Fickett","Hexamer"))
...
write.table(output,file="HH/HL/up/names.cpat",quote=F,sep="\t",row.names=ID)

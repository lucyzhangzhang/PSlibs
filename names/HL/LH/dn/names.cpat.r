...
test <- read.table(file="HL/LH/dn/names.cpat.dat",sep="\t",col.names=c("ID","mRNA","ORF","Fickett","Hexamer"))
...
write.table(output,file="HL/LH/dn/names.cpat",quote=F,sep="\t",row.names=ID)
